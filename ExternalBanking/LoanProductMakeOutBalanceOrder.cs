...
{
    public class LoanProductMakeOutBalanceOrder : Order
    {
        /// <summary>
        ...
        public ActionResult Save(string userName, SourceType source, ACBAServiceReference.User user)
        {
            ...
            {
                result = LoanProductMakeOutBalanceOrderDB.Save(this, userName, source);
        ...
        public ActionResult Validate()
        {
            ...
            result.Errors.AddRange(Validation.ValidateLoanProductMakeOutBalanceOrder(this));
            return result;
        }
        ...
        {
            return LoanProductMakeOutBalanceOrderDB.IsExistsNotConfirmedOrder(this);
        }
        ...
        {
            return LoanProductMakeOutBalanceOrderDB.IsQualityWrong(this);
        }
