...
{
    public class LoanProductClassificationRemoveOrder : Order
    {
        ...
        public ActionResult Save(string userName, SourceType source, ACBAServiceReference.User user)
        {
            ...
            {
                result = LoanProductClassificationRemoveOrderDB.Save(this, userName, source);
        ...
        public ActionResult Validate()
        {
            ...
            result.Errors.AddRange(Validation.ValidateLoanProductClassificationRemoveOrder(this));
            return result;
        }

        /// <summary>
        /// Դասակարգված վարկի դասի հեռացման հայտի հաստատում
        /// </summary>
        ...
        /// <summary>
        /// Դասակարգված վարկի դասի հեռացման հայտի հաստատաման ստուգումներ
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///Դասակարգված վարկի դասի հեռացման հայտի պահպանում և ուղարկում
        /// </summary>
        ...
        /// <summary>
        /// Դասակարգված վարկերի դասի հեռացման հայտերի ավտոմատ ստեղծում նախնական հայտերի հիման վրա
        /// </summary>
        /// <param name="preOrderId"></param>
        /// <returns></returns>
        public static List<LoanProductClassificationRemoveOrder> GenerateOrdersFromAutomaticGenaratedPreOrdersAsync(long preOrderId)
        {

            return LoanProductClassificationRemoveOrderDB.GenerateOrdersFromAutomaticGenaratedPreOrdersAsync(preOrderId).Result;
        }
        /// <summary>
        ...
        {
            return LoanProductClassificationRemoveOrderDB.IsExistsNotConfirmedOrder(this);
        }
        /// <summary>
        /// Ստուգվում է տվյալ կարգավիճակով վարկը հնարավոր է հետ բեչել, թե ոչ
        /// </summary>
        /// <returns></returns>
        public bool IsQualityWrong()
        {
            return LoanProductClassificationRemoveOrderDB.IsQualityWrong(this);
        }
    }
}
