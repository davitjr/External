...
{
    class HBApplicationFullPermissionsGrantingDB
    {
        internal static ActionResult Save(HBApplicationFullPermissionsGrantingOrder order, string userName, SourceType source)
        {
            ...
            using (SqlConnection conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["HbBaseConn"].ToString()))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    conn.Open();
                    cmd.Connection = conn;
                    cmd.CommandText = "pr_HB_Application_Full_Permissions_Granting_Order";
        ...
        internal static HBApplicationFullPermissionsGrantingOrder GetHBApplicationFullPermissionsGrantingOrder(HBApplicationFullPermissionsGrantingOrder order)
        {
